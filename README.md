...
[^1]: See file [Auto_off.md](https://github.com/rpanizzon/ha-smarttemp/blob/main/Auto_off.md) for my Automation to turn the AC off after a defined number of hours.